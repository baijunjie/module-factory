...
module.exports = class Creator {
  ...
  async create (cliOptions = {}) {
    ...
    log()
    pkg.scripts = await this.getModuleApply('@module-factory/service')(context)
    const files = await this.getModuleApply('@module-factory/template')(cliOptions.className, pkg)
  ...
  getModuleApply (moduleName) {
    const resolvedPath = resolveModule(moduleName, this.context)

    if (!resolvedPath) {
      pauseSpinner()
      error(`The dependency module ${moduleName} is missing.`)
