...
module.exports = class Creator {
  ...
  async create (cliOptions = {}) {
    ...
    log()
    const files = await this.getTemplateFiles(cliOptions.className, pkg)
  ...
  async getTemplateFiles (className, pkg) {
